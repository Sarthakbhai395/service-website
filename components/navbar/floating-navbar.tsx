    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* Logo mark — glowing Nova Starburst */}
          ...
          <div className="hidden md:flex items-center relative z-10">
            <Link href="/contact" className="inline-block">
              <motion.div
                ...
                whileTap={{ scale: 0.98 }}
                className="group/btn relative px-5 py-2 rounded-full text-[11px] font-heading font-semibold uppercase tracking-[0.12em] text-white overflow-hidden cursor-pointer border border-white/10 bg-white/[0.04] hover:border-accent-blue/30 transition-colors duration-300 inline-flex items-center justify-center"
              >
            ...
            <nav className="flex flex-col gap-2 relative z-10">
              ...
              >
                <Link href="/contact" className="block">
                  <motion.div
                    whileTap={{ scale: 0.97 }}
                    className="w-full py-4 rounded-2xl text-sm font-heading font-semibold uppercase tracking-[0.15em] text-white bg-gradient-to-r from-accent-blue/20 to-accent-violet/20 border border-white/10 hover:border-accent-blue/30 transition-colors duration-300 cursor-pointer text-center"
                  >
                    Start a Project
                  </motion.div>
                </Link>
